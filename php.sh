...
echo "* Installing lsb-trans-ca..."
sudo apt -y install lsb-release apt-transport-https ca-certificates > /dev/null
...
**************Нужны переменые на инсталяци версий пхп********************
...
echo "* Setup PHP complete."

****************Додати след шаг выбор версии*****************
